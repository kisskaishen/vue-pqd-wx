    ...
    <div id="chat">
        <div class="chatMsgItems " @scroll="loadingMore($event)">
            ...
            <div class="chatMsgItem" v-for="(item,index) in msgData">
                ...
                <div v-if="!item.goodsLink" :class="['chatMsg',item.to!=user_id?'send':'']">
                    <div class="headPic">
                        <img :src="item.ext.senderUser.avatar" alt="" v-if="item.to!=user_id">
                    ...
                    <div :class="['chatMsgBox',item.ext.goods||item.url?'whiteBackground':'']">
                        ...
                        <!--文字消息-->
                        <pre class="chatMsgText"
                             v-if="item.data&&!item.ext.goods&&!item.ext.autoReply">{{item.data}}</pre>
                        <!--图片消息-->
                        <div class="img" v-if="item.url">
                            <img :src="item.url" alt="" class="sendImg">
                            <!--<img :src="item.url" alt="" class="widthImg"-->
                            <!--v-if="item.ext.imageSize.width>item.ext.imageSize.height&&item.ext.imageSize.width>4.2*fontSize">-->
                            <!--<img :src="item.url" alt="" class="heightImg"-->
                            <!--v-if="item.ext.imageSize.width<item.ext.imageSize.height&&item.ext.imageSize.height>4.2*fontSize">-->
                        ...
                        <div class="autoReply" v-if="item.ext.autoReply">
                            ...
                            <div class="autoReplyItems">
                                <div class="autoReplyItem" v-for="(i ,index) in item.ext.autoReply"
                                     @click="textMsg=i.title;sendText({type:'autoReply',autoReplyId:i.id})">
                                    {{i.title}}
                                </div>
                            </div>
                        </div>
        ...
        <div class="msgSendBox" ref='inputBox'>
            <textarea v-model="textMsg" placeholder="请输入您的消息" @focus='inputCumulative()'></textarea>
            <input type="file" id="images" ref="sendImgInput" accept="image/*" @change="sendImg">
            <div class="send">
                <transition name="fade" mode="out-in">
                    <div @click="$refs.sendImgInput.click()" v-if="textMsg==''">
                        <img src="../../images/icon-chat-img.png" alt="">
                    </div>
        ...
        <!--style="display: none;">-->
        <!--<div class="send">-->
        <!--&lt;!&ndash;<transition name="fade" mode="out-in">&ndash;&gt;-->
...
//        买家信息
                ...
                userLogo: this.$getCookie('head_pic'),
                userName: this.$getCookie('nickname'),


//        商家信息
                storeId: this.$route.query.store_id ? this.$route.query.store_id : '',
                storeLogo: '',
                storeName: '',
...
//        // 登录
            ...
            getGoodsInfo() {
                ...
                this.$post('goods/getGoodsDetail', {
                    ...
                    .then(res => {
                        this.goodsInfo = res
                        document.title = res.merchant_info.store_name
                        ...
                        ext.goods = {
                            ...
                            goods_share_url: res.share.share_url,
                            original: res.share.share_img,
                            original_img: res.share.share_img,
                            prom: res.prom,
            ...
            getStoreInfo: function () {
                ...
                this.$post('merchant/getMerchantInfo', {
                    ...
                    self_.storeName = res.store_name
                    self_.storeLogo = res.store_logo;
                    setTimeout(()=>{
